...
- ~~뉴트럴 연동 목업 배경 (지금은 고정 `#ffffff`/`#171717`)~~ **해소 (2026-08-09, 커밋 `ac5db5b`)**:
  팔레트 생성기 색 시스템 확장(`2026-08-09-palette-generator-color-system-design.md`) Task 8에서
  목업 패널 배경이 사용자의 뉴트럴 50/950으로 교체됐다 — 고정 hex는 더 이상 남아있지 않다.
