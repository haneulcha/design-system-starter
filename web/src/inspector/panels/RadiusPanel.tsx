...
function TokenTriplet({ style }: { style: RadiusStyle }) {
  ...
  return (
    <span className="inline-flex items-baseline gap-2">
      <span>
        <span className="text-neutral-400">btn</span> {fmt(p.button)}
      </span>
      <span className="text-neutral-300">·</span>
      <span>
        <span className="text-neutral-400">in</span> {fmt(p.input)}
      </span>
      <span className="text-neutral-300">·</span>
      <span>
        <span className="text-neutral-400">card</span> {p.card}
      </span>
    </span>
  );
}
